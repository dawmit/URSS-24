...
public class ECCJPAKECurves 
{
    ...
    static{
        ...
        NIST_P256 = new ECCJPAKECurve(a_p256, b_p256, q_p256, h_p256, n_p256, g_p256, curve_p256, true);
    }


    public static final ECCJPAKECurve NIST_P384;
    ...
    static{
        ...
        NIST_P384 = new ECCJPAKECurve(a_p384, b_p384, q_p384, h_p384, n_p384, g_p384, curve_p384, true);
    }

    public static final ECCJPAKECurve NIST_P521;
    ...
    static{
        ...
        NIST_P521 = new ECCJPAKECurve(a_p521, b_p521, q_p521, h_p521, n_p521, g_p521, curve_p521, true);
    }
